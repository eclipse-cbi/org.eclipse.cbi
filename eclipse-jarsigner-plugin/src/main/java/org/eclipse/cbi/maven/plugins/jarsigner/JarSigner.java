...
public class JarSigner {
	...
	/**
	 * The retry limit that will be passed to the {@link Signer#trySign(Path, int, int, TimeUnit)}.
	 */
	private final int retryLimit;

	/**
	 * The retry timer that will be passed to the {@link Signer#trySign(Path, int, int, TimeUnit)}.
	 */
	private final int retryTimer;

	/**
	 * The retry timer time unit that will be passed to the {@link Signer#trySign(Path, int, int, TimeUnit)}.
	 */
	 ...
	 */
	private JarSigner(Signer signer, int maxdepth, boolean continueOnFail, Log log, int retryLimit, int retryTimer, TimeUnit retryTimerUnit) {
		this.signer = signer;
	...
	private int signJarRecursively(Path file, int currentDepth) throws IOException, MojoExecutionException {
		...
		if (!signer.sign(file, retryLimit, retryTimer, retryTimerUnit)) {
	 ...
	 */
	public static JarSigner.Builder builder(Signer signer) {
